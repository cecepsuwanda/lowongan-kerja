...
?>
     <img src="images/warning.png" width='20' height='20' />
         <h3>
         	  <blink> 
         	  	 Maaf, Anda harus login terlebih dahulu untuk melihat detail dari perusahaan ini !, Jika anda belum punya akun silahkan daftar dengan mengklik tombol dibawah. 
         	  </blink>
         </h3>
      <center>
      	 <button style='width:120px;' onclick=location.href='?page=registrasi'>
      	 	    <img src="images/daftar.png" width='15' height='15' /> Daftar Disini
      	 </button>
<?php
}
  else
...
?>
     <table border='0' width='700'>
       <?php
         if($jml>0){
       ?>
          <a onclick="return confirm('Anda yakin akan membatalkan lamaran anda pada perusahaan ini ?');" href='?page=detail_lowongan&batal=ok&id=<?php echo $_GET['id'];?>&idp=<?php echo $_GET['idp'];?>' >
          	   <button style='width:340px;' class='tombol'>
          	   	  <img src="images/hapus.png" width='20' height='20' /> Lamaran Sudah Dikirim, Batalkan Lamaran !
          	   </button>
          </a>
<?php
        }else{
?>
               <a  onclick="return confirm('Anda yakin akan mendaftarkan diri anda pada perusahaan ini ?');" href='?page=detail_lowongan&kirim=ok&id=<?php echo $_GET['id'];?>&idp=<?php echo $_GET['idp'];?>' >
               	        <button style='width:185px;' class='tombol'>
               	        	 <img src="images/kirim.png" width='20' height='23' /> Kirim Lamaran Anda !
               	        </button>
               </a>
<?php
             }
...
<?php
    ...
    $batal=isset($_GET['batal']) ? $_GET['batal']:'';
